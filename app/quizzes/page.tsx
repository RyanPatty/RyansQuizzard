...
import type { QuizSet } from "@/types/data"
...
export default function QuizzesPage() {
  ...
  const filteredSets = quizSets.filter(
    (set) =>
  ...
  const handleDeleteSet = (id: string) => {
    if (confirm("Are you sure you want to delete this quiz?")) {
      setQuizSets((sets) => sets.filter((set) => set.id !== id))
    }
  }
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Quiz Sets</h1>
        ...
        {filteredSets.length > 0 ? (
                  ...
                  <div className="flex items-start justify-between">
                    ...
                    <div className="flex gap-1 ml-2">
                      ...
                      <Button
                        variant="ghost"
                        size="sm"
                        onClick={() => handleDeleteSet(quiz.id)}
                ...
                <CardContent>
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex gap-2">
                      ...
                      <Badge variant="outline">{Math.round(quiz.questions.length * 2)} min</Badge>
                    </div>
          ...
          <div className="text-center py-16">
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">
              {searchTerm ? "No matching quizzes found" : "No quizzes yet"}
            </h3>
